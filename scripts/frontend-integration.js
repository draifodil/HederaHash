 ...
 * This file demonstrates how to integrate Hederahash with a web frontend
 */

// For React/Vue/Angular applications
export class HederahashClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new HederahashClient(provider, contractAddress);
